...
public sealed class CardTemplate
{
	...
	public bool bExhaust;	//消耗
	public bool bEthereal;	//虚无
}
...
public sealed class CardTemplateData
{
	...
	public static void Init(XmlNode xml)
	{
		foreach (XmlElement element in xml.ChildNodes)
		{
			...
			template.bExhaust = element["bExhaust"] != null ? Convert.ToBoolean(uint.Parse(element["bExhaust"].InnerText)) : false;	//消耗
			template.bEthereal = element["bEthereal"] != null ? Convert.ToBoolean(uint.Parse(element["bEthereal"].InnerText)) : false;	//虚无
